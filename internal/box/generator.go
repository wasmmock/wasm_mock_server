...
const (
	...
	embedFolder  string = "../../ui/build"
	wasmFolder   string = "../../wasm"
	tmplFolder   string = "../../tmpl"
)
...
func main() {
	...
	// Walking through embed directory
	err = filepath.Walk(wasmFolder, func(path string, info os.FileInfo, err error) error {
		relativePath := filepath.ToSlash(strings.TrimPrefix(path, filepath.FromSlash(wasmFolder)))
	...
	// Walking through tmpl directory
	err = filepath.Walk(tmplFolder, func(path string, info os.FileInfo, err error) error {
		relativePath := filepath.ToSlash(strings.TrimPrefix(path, filepath.FromSlash(tmplFolder)))
